...
//Update the texts in the containers
  function load(){
      // hint();
      var str="<?php getText1($userid) ?>";
      // var str = "Helo";
      document.getElementById("lead").innerHTML = str;
      var question = "<?php getQuestion1($userid)?>";
      // var question = "FUCK:";
...
<div id="wrapper">
        ...
        <h4>Remaining snippets to rate: </h4>
         ...
         <div id = "remainingNo1"><?php getRemaining1($userid);?></div><br>
...
<form action="processSubmit1.php" method="post" name="answer" onsubmit="return check(document.answer)">
    ...
    <p>
    <tr>
        <td><input name="scale" value="1" type="radio" id='p15'>1(no presence of aspect)</td>
        <td><input name="scale" value="2" type="radio" id='p14'>2</td>
        <td><input name="scale" value="3" type="radio" id='p13'>3</td>
        <td><input name="scale" value="4" type="radio" id='p12'>4</td>
        <td><input name="scale" value="5" type="radio" id='p11'>5</td>
        <td><input name="scale" value="6" type="radio" id='p10'>6</td>
        <td><input name="scale" value="7" type="radio" id='p9'>7</td>
        <td><input name="scale" value="8" type="radio" id='p8'>8</td>
        <td><input name="scale" value="9" type="radio" id='p7'>9</td>
        <td><input name="scale" value="10" type="radio" id='p6'>10(very high degree)</td>
    </tr>
